    ...
    <div style={{ padding: 20 }}>
      ...
      >
        <h2 style={{ fontWeight: 700, fontSize: 18, color: "#111827" }}>
          Article List {networkStatus === "offline" && "(Offline)"}
        </h2>

        {submitLoading === false &&
          quantityValues[displayList[0]?.DisplayID] && (
            ...
            {queue.length > 0 && (
              <button
                style={{
                  ...
                  border: "none",
                  cursor:
                    networkStatus === "online" ? "pointer" : "not-allowed",
                  fontSize: 14,
                }}
            ...
            >
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleQuantityChange(item.DisplayID, e.target.value)
                  }
                  style={{
                    width: 80,
                    padding: "8px 12px",
                    border: `1px solid ${
                      !quantityValues[item.DisplayID] && submitLoading
                        ? "#ef4444"
                        : "#e5e7eb"
                    }`,
                    borderRadius: "6px",
              ...
              <div>
                ...
                <button
                  ...
                  style={{
                    ...
                    fontSize: 16,
                    cursor:
                      !isCameraReady || cameraError ? "not-allowed" : "pointer",
                    width: "100%",
